...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[           
            InlineKeyboardButton('💡 ᴜᴘᴅᴀᴛᴇ 💡', url=f'https://t.me/{SUPPORT_CHAT}')
            ],[
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton("🎬 ᴍᴏᴠɪᴇs", url="https://t.me/EliteCraft_Movies"), 
            InlineKeyboardButton("💡 ᴜᴘᴅᴀᴛᴇ 💡", url="https://t.me/EliteCraft_Studios")
            ],[      
